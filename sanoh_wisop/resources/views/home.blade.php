...
<div class="container">
    ...
    <div class="flex justify-between items-center my-4">
        ...
        <img src="{{ asset('images/logo/logo-sanoh.png') }}" alt="Logo" class="h-12 w-auto"> <!-- Tambahkan logo -->
    </div>

    <!-- Overview / Statistik -->
    <div class="bg-blue-200 p-4 rounded-lg mb-6">
        <h2 class="text-lg font-semibold">Overview / Statistik</h2>
        <p class="mt-2">Total Documents: 120 | Active Users: 50 | Expired Documents: 10</p> <!-- Contoh overview -->
    </div>
